...
class Player(object):
    ...
    def go_to(self, location):
        ...
        elif not destination_place.locked:
    ...
    def talk_to(self, person):
        ...
        if type(person) != str:
            ...
            person_object = self.place.characters[person]
            print(person_object.name + ' ' + 'says:' + ' ' + person_object.message)
    ...
    def take(self, thing):
        ...
        if type(thing) != str:
            ...
            thing_object = self.place.things[thing]
        "*** YOUR CODE HERE ***"
