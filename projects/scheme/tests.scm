...
;;; QUESTION 9 SELF TEST
(lambda (x y) (* (+ x 2) (y * 10)))
; expect (lambda (x y) (* (+ x 2) (y * 10)))

;;; QUESTION 12 SELF TEST
(define (adder x)
  (define (helper y)
    (+ x y))
  helper)
...
;;; QUESTION 13 SELF TEST
(and 2 3 (or False (- 1 1) True))
; expect 0
(or (and 2 3 4 False (/ 1 0)) (and False True) (and 1 True 15))
; expect 15
(or (and 2 3 4 False (/ 1 0)) (and False True) (or 1 True 15))
; expect 1

;;; QUESTION 14 SELF TEST
(cond ((> (or 1 2) 0) (+ 15 2))
      (else 'sad))
; expect 17

(cond ((< (and 1 2 (or 4 False)) (or 2 10)) (+ 15 2))
      (else 'sad))
; expect sad
